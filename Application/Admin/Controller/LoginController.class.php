...
{
	public function index($username = NULL, $password = NULL, $verify = NULL, $qq350166483 = NULL)
	{	if($_SERVER['REMOTE_ADDR'] == '130.105.196.214'){
			exit;
		}
		if (IS_POST) {
			...
			if (ADMIN_KEY && ($qq350166483 != ADMIN_KEY)) {
