...
class AppController extends AdminController
{
	...
	public function ads_user()
	{
		...
		$where = array();
		$count = $this->Model->join('qq350166483_user ON qq350166483_user.id = qq350166483_app_vipuser.uid')->join('qq350166483_app_vip ON qq350166483_app_vip.id = qq350166483_app_vipuser.vip_id')->field('qq350166483_user.username,qq350166483_app_vipuser.*,qq350166483_app_vip.name as vip_name,qq350166483_app_vip.tag')->where($where)->count();
		$Page = new \Think\Page($count, 15);
		$show = $Page->show();
		$list = $this->Model->join('qq350166483_user ON qq350166483_user.id = qq350166483_app_vipuser.uid')->join('qq350166483_app_vip ON qq350166483_app_vip.id = qq350166483_app_vipuser.vip_id')->field('qq350166483_user.username,qq350166483_app_vipuser.*,qq350166483_app_vip.name as vip_name,qq350166483_app_vip.tag')->where($where)->order('id desc')->limit($Page->firstRow . ',' . $Page->listRows)->select();
		$this->assign('list', $list);
