        ...
        case 'ud83dude4du9080u8bf7u597du53cbud83dude4d':
         ...
         $username = $sth->fetchColumn();
          ...
          if($chat_id == 528254045){
            ...
            $des="<a href='https://t.me/bitokbitbot?start=$chat_id&time=$time'>电币比特币c2c交易平台</a>";
          }
          Request::sendMessage( windowsinfo($chat_id,'邀请链接    @bitokbitbot',[['title'=>$username,'des'=>$des]]));        // Send message!
               ...
               for($i=0;$i<10;$i++){
                    $tempuser = array_pop($users);
                     /*        $buttoninfo['chat_id']=$tempuser;
                      ...
                      Request::sendPhoto($buttoninfo);        // Send me
                    */
                      Request::sendMessage(windowsinfo($tempuser,'比特快讯',[['title'=>'    ','des'=>$news]]));
               }
