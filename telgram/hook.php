...
if(!empty($message['message'])){
      ...
      switch ($text) {
        ...
        case 'ud83dude4du9080u8bf7u597du53cbud83dude4d':
          ...
          $time=time(); 
          Request::sendMessage( windowsinfo($chat_id,'邀请链接',[['title'=>empty($message['message']['chat']['username'])?$message['message']['chat']['username']:$message['message']['chat']['first_name'],'des'=>"<a href='https://t.me/bitokbitbot?start=$chat_id&time=$time'>电币比特币c2c交易平台</a>"]]));        // Send message!
          break;
        default:
          $pdo  = DB::getPdo();
