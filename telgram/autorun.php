...
file_get_contents("http://telgram.bitneworld.com/telgram/pchart/Example25.php");
$hour=date("H",$time);
$min=date("i",$time);
if($hour >2 && $hour <6){
    if($min/10 < 5){
...
$shoukuanmark=[
    //-----------------------------------------------------------------------
    'jiaojiaoka@gmail.com  支付宝  张娇 备注单号 火速放行',
    '百度钱包账号    18640428281',
    ...
    '中国建设银行  6236682000024314246  张训  大于5万分开转，单在人在，10分钟内放行',
