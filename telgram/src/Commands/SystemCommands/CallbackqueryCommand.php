...
//                  Request::sendPhoto($buttoninfo);        // Send me 
            ...
            case 'jiaoyimark':
                Request::sendMessage(windowsinfo($sendtomessageid,'交易说明',[
                    ['title'=>'1:','des'=>'请在30分钟内完成支付，超过30分钟未完成支付将会自动取消订单'],
                    ['title'=>'2:','des'=>'支付完成或对方确认支付后，买方出现申诉按钮，卖方出现申诉以及放行按钮，卖方确认收款后，点击放行，双方有任何问题都可以发起申诉'],
                    ['title'=>'3:','des'=>'请在收到对方汇款30分钟内，完成确认收款放行动作。超过30分钟未放行，客服介入处理.'],
                    ['title'=>'4:','des'=>'请勿在汇款备注、说明栏目中填写比特币、BTC等任何数字货币字符字眼，防止您的汇款行为被银行拦截，可以填写订单编号。'],
                    ['title'=>'5:','des'=>'5w以上汇款请分批支付确保到款的及时性。为了交易的及时性，请选择及时到账的汇款方式（如支付宝支付、微信支付、银行及时汇款等）'],
                    ['title'=>'6:','des'=>'对于交易纠纷，平台拥有最终裁判权。对于一些恶意冻结订单、恶意付款、利用交易涉嫌诈骗等行为，平台有权冻结其法币交易使用权限。'],
                    ['title'=>'7:','des'=>'比特币提现手续费 0.0005 BTC/笔']
                ]));
                break; 
            default:
                # code...
